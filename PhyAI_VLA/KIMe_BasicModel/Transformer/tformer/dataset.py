...
class TranslationDatasetForOpusbooks(Dataset):
...
class TranslationDatasetForLemonmint(TranslationDatasetForOpusbooks):

    def __init__(self, ds, tokenizer_src, tokenizer_tgt, src_lang, tgt_lang, seq):
        super().__init__(ds, tokenizer_src, tokenizer_tgt, src_lang, tgt_lang, seq)
